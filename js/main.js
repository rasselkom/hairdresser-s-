...
$(window).scroll(function () {
  var oTop = $('.about__counter').offset().top - window.innerHeight;
  if (a == 0 && $(window).scrollTop() > oTop) {
    $('.about__counter-value').each(function () {
      var $this = $(this),
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination]);
const swiper1 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider', {
  slidesPerView: 1,
  spaceBetween: 10,
  loop: true,
  pagination: {
